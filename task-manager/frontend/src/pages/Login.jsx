      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-extrabold text-white tracking-tight">
            Welcome to Task<span className="text-indigo-400">Flow</span>
          </h2>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-zinc-900/60 border border-zinc-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 hover:border-zinc-700/60 rounded-xl pl-11 pr-4 py-3 text-zinc-200 text-sm outline-none transition-all duration-200"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-zinc-900/60 border border-zinc-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 hover:border-zinc-700/60 rounded-xl pl-11 pr-11 py-3 text-zinc-200 text-sm outline-none transition-all duration-200"
                  required
                />
                <button
                  type="button"
